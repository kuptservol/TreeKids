...
return array(
    ...
    'header' => array(
      ...
      'items' => array(
        ...
        'header_search_bg_color' => array(
	      ...
	      'header_mini_cart_heading_color' => array(
		      'label' => _t('text_style_header_mini_cart_heading_color', 'Mini Cart Heading Color'),
		      'type' => 'color',
		      'format' => 'rgba'
	      ),
	      'header_mini_cart_heading_icon_color' => array(
		      'label' => _t('text_style_header_mini_cart_heading_icon_color', 'Mini Cart Heading Icon Color'),
		      'type' => 'color',
		      'format' => 'rgba'
	      ),
        'header_mini_cart_color' => array(
	      ...
	      'header_mini_cart_title_bg_color' => array(
		      'label' => _t('text_style_header_mini_cart_title_bg_color', 'Mini Cart Title Background Color'),
		      'type' => 'color',
		      'format' => 'rgba'
	      ),
    ...
    'product' => array(
      ...
      'items' => array(
        ...
        'product_buttons_bg_color' => array(
          'label' => _t('text_style_product_buttons_bg_color', 'Wishlist/Compare Background Color'),
          'type' => 'color',
          'format' => 'hex'
        ),
    ...
    'promotion' => _t('text_position_promotion', 'Promo'),
