...
<div id="top-bar">
    <div class="container">
        ...
        <!--skuptsov  <div class="col-md-2 col-sm-12 extra">
            ...
            <div class="col-md-2 col-sm-12 col-no-padding">
                <div class="social">
...
<div id="header">
    <div class="container">
        <div class="row">
            <?php if ($logo) { ?>
            <div id="logo" class="col-md-2 col-xs-12 wow fadeInLeft" data-wow-delay="0.1s">
                ...
                <div class="navigation">
                    <div class="container">
                      <span id="btn-mobile-toggle">
                        ...
                        ?>
                        <?php if ($kuler->getSkinOption('multi_level_default_menu')) { $categories =
                        $kuler->getRecursiveCategories(); } ?>
                        <div id="menu" class="container">
                            <div class="row">
                                <ul class="mainmenu">
                                    <li style="display: none;"><a><?php echo $kuler->
                                            translate($kuler->getSkinOption('mobile_menu_title')); ?></a></li>
                                    <li class="item"><a href="<?php echo $base; ?>" <?php if ($kuler->
                                        getSkinOption('home_icon_type') == 'icon') { ?> class="home-icon" <?php } ?>
                                        ><?php echo $kuler->language->get('text_home') ?></a></li>
