...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
  <head>
    ...
    <?php if ($direction == "rtl") { ?>
      <link rel="stylesheet" type="text/css" href="catalog/view/theme/decao/stylesheet/rtl.css" media="screen">
    <?php } ?>
  </head>
...
<?php } ?>
  <?php if ($kuler->getRootSkin() == 'skin1'||$kuler->getRootSkin() == 'skin2' ||$kuler->getRootSkin() == 'skin4') { ?>
  <?php include(DIR_TEMPLATE . Kuler::getInstance()->getTheme() . '/template/common/_header_skin1.tpl'); ?>
  <?php } elseif ($kuler->getRootSkin() == 'skin3'){ ?>
  <?php include(DIR_TEMPLATE . Kuler::getInstance()->getTheme() . '/template/common/_header_skin3.tpl'); ?>
  <?php } elseif ($kuler->getRootSkin() == 'skin5' ||$kuler->getRootSkin() == 'skin6'){ ?>
  <?php include(DIR_TEMPLATE . Kuler::getInstance()->getTheme() . '/template/common/_header_skin5.tpl'); ?>
  <?php } ?>
