...
$settings['css_class'] = !empty($settings['css_class']) ? $settings['css_class'] : '';
?>

<div class="kuler-showcase-module<?php echo ' ' . $settings['css_class']; ?>" id="kuler-showcase-module-<?php echo $module; ?>">
