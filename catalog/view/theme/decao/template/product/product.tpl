...
$kuler->language->load('kuler/decao');
?>
<?php echo $header; ?>
...
<div class="container">
  ...
  <?php if ($review_status) { ?>
    <div class="review">
      <div>
        <img src="catalog/view/theme/decao/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
  ...
  <div class="related-products">
      <h2 class="row-heading"><?php echo $kuler->language->get('text_related_products'); ?></h2>
