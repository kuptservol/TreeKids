        ...
        <div id="content" class="col-xs-12">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 buttons">
                    <h2 class="row-heading"><?php echo $text_your_password; ?></h2>
                    <table class="form">
                        <tr>
                            <td><?php echo $entry_password; ?> <span class="required">*</span></td>
                            <td><input type="password" name="password" value="" class="large-field" /></td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_confirm; ?> <span class="required">*</span></td>
                            <td><input type="password" name="confirm" value="" class="large-field" /></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6 col-sm-12 buttons">
