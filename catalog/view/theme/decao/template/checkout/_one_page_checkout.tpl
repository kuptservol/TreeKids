	...
	<div class="checkout-info row">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="fax" class="large-field" value="<?php echo $fax; ?>" tabindex="6" />

            <div id="company-id-display">
              <?php echo _t('entry_company_id'); ?><br />
              <input type="text" name="company_id" class="large-field" value="<?php echo $company_id; ?>" tabindex="8" />
            </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="company" class="large-field" value="<?php echo $company; ?>" tabindex="7" />

            <div id="tax-id-display"><?php echo _t('entry_tax_id'); ?><br />
              <input type="text" name="tax_id" class="large-field" value="<?php echo $tax_id; ?>" tabindex="9" />
            </div>

            <input type="text" name="address_2" class="large-field" value="<?php echo $address_2; ?>" tabindex="10" />

            <span id="postcode-required" class="required">*</span> <?php echo _t('entry_postcode'); ?><br />
            <input type="text" name="postcode" value="<?php echo $postcode; ?>" class="large-field" tabindex="11" />
          </div>
        </div>
