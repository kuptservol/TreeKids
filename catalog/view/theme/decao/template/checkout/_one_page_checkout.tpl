	...
	<div class="checkout-info row">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="firstname" class="large-field" value="<?php echo $first_name; ?>" tabindex="1" />

            <span class="required">*</span> <?php echo _t('entry_email'); ?><br />
            <input type="text" name="email" class="large-field" value="<?php echo $email; ?>" tabindex="3" />

            <!--<?php echo _t('entry_fax'); ?><br />-->
            <input type="hidden" name="fax" class="large-field" value="<?php echo $fax; ?>" tabindex="6" />

              <div id="company-id-display">
                  <!--<?php echo _t('entry_company_id'); ?><br />-->
                  <input type="hidden" name="company_id" class="large-field" value="<?php echo $company_id; ?>" tabindex="8" />
                </div>

                <span class="required">*</span> <?php echo _t('entry_address_1'); ?><br />
                <input type="text" name="address_1" class="large-field" value="<?php echo $address_1; ?>" tabindex="10" />

                <span class="required">*</span> <?php echo _t('entry_city'); ?><br />
                <input type="text" name="city" class="large-field" value="<?php echo $city; ?>" tabindex="12" />
              </div>
              <div class="col-md-6">
                <span class="required">*</span> <?php echo _t('entry_lastname'); ?><br />
                <input type="text" name="lastname" class="large-field" value="<?php echo $last_name; ?>" tabindex="2" />

                <span class="required">*</span> <?php echo _t('entry_telephone'); ?><br />
                <input type="text" name="telephone" class="large-field" value="<?php echo $telephone; ?>" tabindex="4" />

                  <!--<?php echo _t('entry_company'); ?><br />-->
                <input type="hidden" name="company" class="large-field" value="<?php echo $company; ?>" tabindex="7" />

                <div id="tax-id-display"><!--<?php echo _t('entry_tax_id'); ?><br />-->
                  <input type="hidden" name="tax_id" class="large-field" value="<?php echo $tax_id; ?>" tabindex="9" />
                </div>

                <input type="hidden" name="address_2" class="large-field" value="<?php echo $address_2; ?>" tabindex="10" />

                  <!--<span id="postcode-required" class="required">*</span> <?php echo _t('entry_postcode'); ?><br />-->
                <input type="hidden" name="postcode" value="<?php echo $postcode; ?>" class="large-field" tabindex="11" />
          </div>
        </div>
