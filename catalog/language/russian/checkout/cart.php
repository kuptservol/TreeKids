...
$_['text_shipping_method']   = 'Пожалуйста, выберите the preferred shipping method to use on this order.';
...
// Error
$_['error_stock']            = 'Деревья, помеченные, как *** не доступны в нужно количестве!';
...
$_['error_profile_required'] = 'Пожалуйста, выберите a payment profile!';
