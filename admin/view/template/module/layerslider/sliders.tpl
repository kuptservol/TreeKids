	...
	<section class="wrapper">
		<div class="row">
			<div class="col-sm-12">
				...
				<section class="panel">
					<nav class="navbar navbar-inverse" role="navigation">
						<div class="navbar-header">
							<h2>
								<img id="logo" src="view/kulercore/images/logos/kuler_layer_slider.png" />
								<?php echo $this->language->get('Layer Slider'); ?>
							</h2>
						</div>

						<ul id="main-tab" class="nav navbar-nav">
                        ...
                        <div class="pull-right" style="padding-top: 12px; padding-right: 10px;">
	                        <div class="btn-group">
				...
				<section class="panel" id="page-content">
						...
						<div class="tab-content">
							<form class="form-horizontal" role="form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
								<div id="tab-slidergroups" class="tab-pane">
									...
									<div class="col-sm-10 slider-form-container">
										<?php if ($id) { ?>
								...
								<div id="tab-listmodules" class="tab-pane" style="padding: 15px;">
									<table id="module" class="table table-hover table-bordered">
									    <thead>
									        <tr>
										        ...
										        <th class="left"><?php echo $this->language->get('Language:') ?></th>
									    ...
									    <?php foreach ($modules as $module) { ?>
									    	...
									    	<tr>
											    ...
											    <td class="left">
												    <select class="form-control" name="kuler_layer_slider_module[<?php echo $module_row; ?>][store_id]" style="width: 250px;">
											    ...
											    <td class="left">
											    	<select class="form-control" name="kuler_layer_slider_module[<?php echo $module_row; ?>][language_id]" style="width: 100px;">
											    		<option value="0"><?php echo $this->language->get('All Languages'); ?></option>
											    		<?php foreach ($languages as $language) { ?>
											    		<option value="<?php echo $language['language_id']; ?>"<?php if (isset($module['language_id']) && $language['language_id'] == $module['language_id']) echo ' selected="selected"'; ?>><?php echo $language['name']; ?></option>
											    		<?php } ?>
											    	</select>
											    </td>
							...
							<div id="tab-importtools" class="tab-pane" style="padding: 15px;">
...
function addModule() {	
	...
	html += '	<td class="left">';
	html += '		<select class="form-control" name="kuler_layer_slider_module[' + module_row + '][language_id]" style="width: 100px;">';
	html += '			<option value="0"><?php echo $this->language->get('All Languages'); ?></option>';
	html += '			<?php foreach ($languages as $language) { ?>';
	html += '			<option value="<?php echo $language['language_id']; ?>"<?php if (isset($module['language_id']) && $language['language_id'] == $module['language_id']) echo ' selected="selected"'; ?>><?php echo $language['name']; ?></option>';
	html += '			<?php } ?>';
	html += '		</select>';
	html += '	</td>';
	...
	html += '			    <option value="<?php echo $position; ?>"<?php if ($module['position'] == $position) echo ' selected="selected"'; ?>><?php echo $name; ?></option>';
	html += '		    <?php } ?>';
	html += '		</select></td>';
