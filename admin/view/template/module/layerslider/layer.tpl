			...
			<div class="col-sm-12">
				...
				<section class="panel">
					<nav class="navbar navbar-inverse" role="navigation">
                        ...
                        <div class="pull-right" style="padding-top: 14px; padding-right: 10px;">
				...
				<section class="panel page-layer" id="page-content">
										...
										<fieldset>
											...
											<div class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-3">
														<input class="form-control" type="text" name="layer_top">
													</div>
													<label class="col-sm-1 control-label"><?php echo $this->language->get("Left"); ?></label>
													<div class="col-sm-3">
														<input class="form-control" type="text" name="layer_left">
													</div>
												</div>
											</div>
										</fieldset>
