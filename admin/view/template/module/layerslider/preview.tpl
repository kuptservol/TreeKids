...
<?php
$typoFile = $url . "catalog/view/theme/default/stylesheet/layerslider/css/typo.css";
if (file_exists(DIR_CATALOG . "view/theme/" . $this->config->get('config_template') . "/stylesheet/layerslider/css/typo.css")) {
	$typoFile = $url . "catalog/view/theme/" . $this->config->get('config_template') . "/stylesheet/layerslider/css/typo.css";
}
...
<head>
	...
	<script type="text/javascript"
		src="<?php echo $url; ?>catalog/view/javascript/layerslider/jquery.themepunch.plugins.min.js"></script>
	<script type="text/javascript"
		src="<?php echo $url; ?>catalog/view/javascript/layerslider/jquery.themepunch.revolution.js"></script>
	...
	<div class="kls-banner">
		<ul>
			...
			<li
				...
				<?php } else if ($slider['image']) { ?>
					<img src="<?php echo $url . "image/". $slider['image']; ?>" />
				<?php } ?>
